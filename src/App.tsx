...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  container: { display: 'flex', flexDirection: 'column', height: '100vh', backgroundColor: '#0d1527', color: '#f8fafc', position: 'relative' as const },
  
  // ESTILOS DE BARRA SUPERIOR CON LOGO CIRCULAR AMPLIADO
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 20px', backgroundColor: '#152238', borderBottom: '1px solid #1e293b', height: '64px' },
  ...
  main: { flex: 1, overflowY: 'auto', padding: '14px' },
  ...
  footer: { padding: '10px 16px', backgroundColor: '#0d1527', borderTop: '1px solid #1e293b', display: 'flex', flexDirection: 'column', gap: '6px' },
